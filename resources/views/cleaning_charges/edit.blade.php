...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <h5  class="my-1 float-left">{{ !empty($cleaningCharge->name) ? $cleaningCharge->name : 'Cleaning Charge' }}</h5>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('cleaning_charges.cleaning_charge.update', $cleaningCharge->id) }}" id="edit_cleaning_charge_form" name="edit_cleaning_charge_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
