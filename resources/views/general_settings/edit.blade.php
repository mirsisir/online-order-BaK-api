...
{{--                </a>--}}
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('general_settings.general_settings.update', $generalSettings->id) }}" id="edit_general_settings_form" name="edit_general_settings_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
