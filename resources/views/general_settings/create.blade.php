...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('general_settings.general_settings.store') }}" accept-charset="UTF-8" id="create_general_settings_form" name="create_general_settings_form" class="form-horizontal">
            {{ csrf_field() }}
